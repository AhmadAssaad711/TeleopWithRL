...
if __package__ in (None, ""):
    ...
    from TeleopWithRL.matlab_literal_env.studies.rewarding import baseline_reward_variant, reward_variant_from_name
    from TeleopWithRL.matlab_literal_env.studies.saved_policy_eval import evaluate_saved_policy, save_evaluation_bundle
else:
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run DQN-only experiments for matlab_literal_env.")
