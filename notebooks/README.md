...
The result READMEs are intentionally scoped to their experiment family. Each
source experiment notebook now ends with its own exact Results section and
embedded graph(s); the underlying comparable-run audit remains in
