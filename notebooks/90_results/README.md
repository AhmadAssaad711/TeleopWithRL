...
This README is the self-contained review surface for the current comparable
results. It contains the exact tables and graphs; the companion notebook
`90_results_catalog.ipynb` displays the same tracked assets programmatically.
...
The machine-readable catalog is [`../../results_index/runs.csv`](../../results_index/runs.csv).
