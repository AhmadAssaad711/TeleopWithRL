...
if __package__ in (None, ""):
    ...
    from TeleopWithRL.matlab_env_python_replica.studies.dqn_state_variants import get_dqn_state_variant
    from TeleopWithRL.matlab_env_python_replica.studies.rewarding import baseline_reward_variant, reward_variant_from_name
    from TeleopWithRL.matlab_env_python_replica.studies.saved_policy_eval import evaluate_saved_policy, save_evaluation_bundle
else:
    ...
    from ..studies.rewarding import baseline_reward_variant, reward_variant_from_name
