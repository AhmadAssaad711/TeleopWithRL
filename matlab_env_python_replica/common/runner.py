"""Shared orchestration engine for replica studies and saved-policy checks.

Algorithm-specific command modules delegate training and evaluation work here.
The runner accepts normalized experiment arguments and writes manifests,
summaries, histories, and plots under the selected result directory.
"""
...
if __package__ in (None, ""):
    ...
    from TeleopWithRL.matlab_env_python_replica.dqn.state_variants import build_dqn_state_variants, get_dqn_state_variant
    from TeleopWithRL.matlab_env_python_replica.ql.training import train_qlearning_variant
    from TeleopWithRL.matlab_env_python_replica.ql.state_variants import build_ql_state_variants, get_ql_state_variant
    ...
    from TeleopWithRL.matlab_env_python_replica.common.saved_policy_eval import (
    ...
    from .cli import replica_env_kwargs_from_args
    from .study_utils import results_root, save_json, stage_completed, stage_summary_rows_to_csv, study_root
    from ..dqn.training import train_dqn_variant
    from ..dqn.state_variants import build_dqn_state_variants, get_dqn_state_variant
    from ..ql.training import train_qlearning_variant
    from ..ql.state_variants import build_ql_state_variants, get_ql_state_variant
    from .rewarding import baseline_reward_variant, build_core_reward_variants, build_full_reward_variants
    from .rewarding import reward_variant_from_name
    from .saved_policy_eval import evaluate_saved_policy, save_evaluation_bundle
