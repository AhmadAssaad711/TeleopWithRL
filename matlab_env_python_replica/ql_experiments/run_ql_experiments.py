...
if __package__ in (None, ""):
    ...
    from TeleopWithRL.matlab_env_python_replica.studies.ql_state_variants import get_ql_state_variant
    from TeleopWithRL.matlab_env_python_replica.studies.rewarding import baseline_reward_variant
