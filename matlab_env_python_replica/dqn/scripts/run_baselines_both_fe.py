"""CLI entry point that launches the DQN baseline for both FE modes.

Notebook cells call this module with ``python -m``. It parses experiment
arguments, launches the reusable DQN experiment runner twice, and reports the
two result roots; training logic lives in :mod:`..training` and
:mod:`...common.runner`.
"""
...
def main() -> None:
    """Run the configured DQN baseline once for each FE mode."""
    parser = argparse.ArgumentParser(
        description="Run the DQN baseline on both FE modes and write isolated result folders."
    )
