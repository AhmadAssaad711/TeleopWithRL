"""DQN training functions that consume the shared replica environment.

The public training functions build an environment factory, run one configured
variant, and write model/checkpoint, history, metric, and summary artifacts to
